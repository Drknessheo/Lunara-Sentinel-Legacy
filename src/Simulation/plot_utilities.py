...
def plot_metric_perturbation(
    x: np.ndarray,
    h_final: np.ndarray,
    t_final: float,
    filename: str = "metric_perturbation_plot.png",
):
    """
...
def plot_clock_phase(
    t: np.ndarray, clock_phase: np.ndarray, filename: str = "clock_phase_plot.png"
):
    """

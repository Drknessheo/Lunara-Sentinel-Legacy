...
def get_redis():
    ...
    try:
        ...
        redis_url = os.environ.get("REDIS_URL") or getattr(config, "REDIS_URL", None) or "redis://localhost:6379/0"
...
def get_effective_settings(user_id: int):
    ...
    defaults = {
        ...
        "max_hold_time": 3600,
        "signal": None,
        "PROFIT_TARGET_PERCENTAGE": getattr(config, "DEFAULT_SETTINGS", {}).get("PROFIT_TARGET_PERCENTAGE", 1.0),
